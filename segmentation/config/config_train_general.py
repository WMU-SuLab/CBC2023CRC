...
model_path_pretrained_G = './log/2023_07_23_02_37_12'
...
dataset_path = {'CBC': './data/CBC/training/',
'CBC_ft': './data/CBC_ft/training/',
                }
...
print(trainset_path)
print(use_network)
print(f'lambda_BCE: DICE ==== {lambda_BCE}:{lambda_DICE}')
