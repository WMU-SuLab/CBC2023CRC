...
def data_augmentation5_7(image1, image4, image5, image6, image7, image8, image9):
    # image3 = np.expand_dims(image3,-1)
    [image1, image4, image5, image6, image7, image8, image9] = tl.prepro.adjust_hue([image1, image4, image5, image6, image7, image8, image9], zoom_range=[0.7, 1.2], is_random=True,
                                                    fill_mode='constant')
    [image1, image4, image5, image6, image7, image8, image9] = np.squeeze([image1, image4, image5, image6, image7, image8, image9]).astype(np.float32)
...
def data_augmentation2_6(image1, image4, image5, image6, image7, image8):
    # image3 = np.expand_dims(image3,-1)
    [image1, image4, image5, image6, image7, image8] = tl.prepro.zoom_multi([image1, image4, image5, image6, image7, image8], zoom_range=[0.7, 2.2], is_random=True,
                                                    fill_mode='constant')
    [image1, image4, image5, image6, image7, image8] = np.squeeze([image1, image4, image5, image6, image7, image8]).astype(np.float32)

    return image1, image4, image5, image6, image7, image8

def data_augmentation1_5(image1, image4):
    # image3 = np.expand_dims(image3,-1)
    [image1, image4] = tl.prepro.rotation_multi([image1, image4], rg=180, is_random=True,
                                                        fill_mode='constant')
    [image1, image4] = np.squeeze([image1, image4]).astype(np.float32)

    return image1, image4


def data_augmentation3_5(image1, image4):
    # image3 = np.expand_dims(image3,-1)
    [image1, image4] = tl.prepro.shift_multi([image1, image4], wrg=0.10, hrg=0.10, is_random=True,
                                                     fill_mode='constant')
    [image1, image4] = np.squeeze([image1, image4]).astype(np.float32)
...
def data_augmentation4_5(image1, image4):
    # image3 = np.expand_dims(image3,-1)
    [image1, image4] = tl.prepro.elastic_transform_multi([image1, image4], alpha=720, sigma=24,
                                                                 is_random=True)
    [image1, image4] = np.squeeze([image1, image4]).astype(np.float32)
...
def data_augmentation2_5(image1, image4):
    # image3 = np.expand_dims(image3,-1)
    [image1, image4] = tl.prepro.zoom_multi([image1, image4], zoom_range=[0.5, 2.5], is_random=True,
                                                    fill_mode='constant')
    [image1, image4] = np.squeeze([image1, image4]).astype(np.float32)
...
def data_aug5(data_mat, label_mat, choice):
    ...
    if choice == 0:
        ...
        data_mat, label_mat= data_augmentation1_5(data_mat, label_mat)
    elif choice == 4:
        data_mat, label_mat= data_augmentation2_5(data_mat, label_mat)
    elif choice == 5:
        data_mat, label_mat= data_augmentation3_5(data_mat, label_mat)
    elif choice == 6:
        data_mat, label_mat= data_augmentation4_5(data_mat, label_mat)
